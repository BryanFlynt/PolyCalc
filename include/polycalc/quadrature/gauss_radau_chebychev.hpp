...
struct GaussRadauChebychev {

    /** Quadrature Locations
     *
     * Returns the Gauss-Radau-Chebychev quadrature locations at last through first locations.
     */
    ...
    /** Quadrature Locations
     *
     * Returns the Gauss-Radau-Chebychev quadrature locations at n locations.
     */
    ...
    /** Quadrature Weights
     *
     * Returns the Gauss-Radau-Chebychev weights at last-first Radau zeros.
     */
    template <short Z1, typename RandomAccessIterator>
    ...
    /** Quadrature Weights
     *
     * Returns the Gauss-Radau-Chebychev weights at n Radau zeros.
     */
    template <short Z1, typename Iterator>
